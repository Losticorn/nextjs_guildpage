const PrivacyPolicy = () => {
  return (
    <main className="flex flex-col flex-wrap max-w-[1500px] m-auto mb-16 text-white">
      <h1 className="text-6xl text-center py-4 text-white mt-6 ">
        Privacy Policy
      </h1>
      ...
      <div className="my-6">
        ...
        <p>
          Welcome to Dirty Zuk And The Boyz. We are committed to protecting your
          ...
          dirtyzukadntheboyz.com ("Website").
        </p>
      </div>

      <div className="my-6">
        <h2 className="text-xl font-bold my-4">1. Information We Collect</h2>
        ...
        <p>
          ...
          <ul className="list-disc">
            ...
            <li>Make a purchase of boosting service (not implemented yet)</li>
          </ul>
        ...
        <p>
          ...
          interact with our Website, such as:
          <ul className="list-disc">
            <li>IP address</li>
            <li>Browser type</li>
            <li>Device type</li>
      ...
      <div className="my-6">
        ...
        <ul className="list-disc">
          ...
          <li>
            To send you newsletters, promotional offers, and updates (you can
            opt-out at any time)
          </li>
      ...
      <div className="my-6">
        ...
        <p>
          ...
          device that help us remember your preferences, analyze usage, and
      ...
      <div className="my-6">
        <h2 className="text-xl font-bold my-4">4. Sharing Your Information</h2>
        <p>
        ...
        <ul className="list-disc">
          <li>
            ...
            response to a legal process, we may disclose your information to law
            enforcement or other authorities.
          </li>
        </ul>
      </div>
      <div className="my-6">
        <h2 className="text-xl font-bold my-4">5. Data Security</h2>
        <p>
      ...
      <div className="my-6">
        <h2 className="text-xl font-bold my-4">6. Your Rights</h2>
        ...
        <p>
          ...
          <strong> dirtyzukandtheboyz@gmail.com</strong>.
        </p>
      </div>
      <div className="my-6">
        <h2 className="text-xl font-bold my-4">7. Children's Privacy</h2>
        <p>
      ...
      <div className="my-6">
        ...
        <p>
          ...
          significant changes by posting the updated policy on this page with
          the "Effective Date" at the top.
        </p>
      </div>

      <div className="my-6">
        <h2 className="text-xl font-bold my-4">9. Contact Us</h2>
        <p>
          If you have any questions or concerns about this Privacy Policy,
          please contact us at:
        </p>
        <address>dirtyzukandtheboyz@gmail.com</address>
      </div>
    </main>
  );
};
